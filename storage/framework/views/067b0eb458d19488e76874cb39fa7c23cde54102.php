              ...
              <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="10px" data-railOpacity="0.2">
                ...
                <nav class="nav-primary hidden-xs">
                  <ul class="nav bg clearfix">
                    ...
                    <li>
                      <a href="<?php echo e(route('home')); ?>" title="Go to your home page.">
                        <i class="icon-home icon text-info"></i>
                        <span class="font-bold">Home</span>
                      </a>
                    </li>
                    <li>
                      <a href="<?php echo e(route('newchannel')); ?>"  title="Add a new channel.">
                    ...
                    <li>
                      <a href="<?php echo e(route('channels')); ?>" title="View recent channels.">
                  ...
                  <div class="dropdown dropup wrapper-sm clearfix">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      <span class="thumb-sm avatar pull-left m-l-xs">
                        <img src="<?php echo e(asset('images/a3.png')); ?>" class="dker" alt="...">
